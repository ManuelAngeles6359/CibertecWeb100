...
(function () {
    ...
    function customerController(dataService, configService, $state, $scope) {
        ...
        function totalRecords() {
            dataService.getData(apiUrl + '/customer/count').then(function (result) {
        ...
        function getCustomer(id) {
            vm.customer = null;
            dataService.getData(apiUrl + '/customer/' + id).then(function (result) {
        ...
        function updateCustomer() {
            ...
            dataService.putData(apiUrl + '/customer', vm.customer).then(function (result) {
                    vm.customer = {};
        ...
        function createCustomer() {
            if (!vm.customer) return;
            dataService.postData(apiUrl + '/customer', vm.customer).then(function (result) {
        ...
        function deleteCustomer() {
            dataService.deleteData(apiUrl + '/customer/' + vm.customer.id).then(function (result) {
                    getPageRecords(vm.currentPage);
                    closeModal();
                },
                function (error) {
...
(function () {
    ...
    function orderController(dataService, configService, $state, $scope) {
        ...
        function totalRecords() {
            dataService.getData(apiUrl + '/order/count').then(function (result) {
                vm.totalRecords = result.data;
                getPageRecords(vm.currentPage);
            }, function (error) {
                console.log(error);
        ...
        function getOrder(id) {
            vm.order = null;
            dataService.getData(apiUrl + '/order/' + id).then(function (result) {
        ...
        function updateOrder() {
            if (!vm.order) return;
            dataService.putData(apiUrl + '/order', vm.order).then(function (result) {
                vm.order = {};
        ...
        function createOrder() {
            if (!vm.order) return;
            dataService.postData(apiUrl + '/order', vm.order).then(function (result) {
        ...
        function deleteOrder() {
            dataService.deleteData(apiUrl + '/order/' + vm.order.id).then(function (result) {
                getPageRecords(vm.currentPage);
                closeModal();
            },
                function (error) {
...
(function () {
    ...
    function supplierController(dataService, configService, $state, $scope) {
        ...
        function totalRecords() {
            dataService.getData(apiUrl + '/supplier/count').then(function (result) {
                vm.totalRecords = result.data;
                getPageRecords(vm.currentPage);
            }, function (error) {
                console.log(error);
        ...
        function updateSupplier() {
            ...
            dataService.putData(apiUrl + '/supplier', vm.supplier).then(function (result) {
                vm.supplier = {};
        ...
        function createSupplier() {
            if (!vm.supplier) return;
            dataService.postData(apiUrl + '/supplier', vm.supplier).then(function (result) {
        ...
        function deleteSupplier() {
            dataService.deleteData(apiUrl + '/supplier/' + vm.supplier.id).then(function (result) {
                getPageRecords(vm.currentPage);
                closeModal();
            },
                function (error) {
